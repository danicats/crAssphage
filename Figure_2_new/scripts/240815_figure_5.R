#scripts to generate figure 5 plots
library(ggplot2)
library(readxl)
library(dplyr)
library(patchwork)
...
ggsave("241219_figure5_combined.pdf", combined_plot, width = 12, height = 6, units = "in", dpi = 300)

#####for supplementary figure 5A and B##########
